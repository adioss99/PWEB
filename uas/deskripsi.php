  ...
  <div class="container">
    <h1 class="text-center text-white pt-3 mb-2">Detail Buku</h1>
        ...
        <div class="col-lg-3 mt-3">
          <a href="main.php" class="btn btn-primary w-100"><i class="bi bi-arrow-left-short"></i> Kembali</a>
        </div>
        <div class="col-lg-9 mt-3 ">
          <a href="https://wa.me/085956854756" class="btn btn-success w-100" target="_blank"><i class="bi bi-whatsapp"></i> Pesan</a>
        </div>
    </div>
  </div>
