    ...
    <nav class="navbar navbar-expand-lg header">
        <div class="container justify-content-between">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" style="max-height:50px;">
                    <a class="btn btn-primary" href="register.php"
                        style="background-color: #1025A1; margin-left:10px; width: 80px;">
                        Register
                    </a>
                </form>
                <form class="d-flex" style="max-height:50px; padding-left:10px">
                    <a type="submit" href="create.php" name="search" class="btn btn-primary" id="bebas"><i class="bi bi-plus-circle-fill"></i> Create</a>
                </form>
                <form class="d-flex" style="max-height:50px; padding-left:10px; margin-right:-100px">
                    <a type="submit" href="logout.php" name="search" class="btn btn-danger" id="bebas"><i class="bi bi-box-arrow-right"></i> Logout </a>
                </form>
            </div>
        </div>
    </nav>
            ...
            $.get(`model/view.php?lastid=${id}`, function(response) {
                ...
                response.forEach(element => {
                    $("#hasil").append(`<div class="col-xl-3 col-md-6 mb-4">
                                            <div class="card">
                                                <a href= "detail.php?id=${element.id_buku}"><img src="assets/${element.id_buku}.jpg" class="card-img-top image-crop"></a>
                                                <div class="card-body">
                                                    <h6 class="card-text">${element.judul_buku}</h6>
                                                    <div class="d-flex justify-content-between">
                                                        <p class="text-danger">Harga : ${element.harga}</p>
                                                        <div>
                                                            <a href="update.php?id=${element.id_buku}"><button class="btn btn-warning btn-sm"><i class="fas fa-edit" style="color:white"></i></button></a>
                                                            <a href="model/delete.php?id=${element.id_buku}"><button class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></button></a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
